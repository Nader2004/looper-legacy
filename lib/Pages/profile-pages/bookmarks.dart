...
class BookmarksListPage extends StatefulWidget {
  BookmarksListPage({Key key}) : super(key: key);

  @override
  _BookmarksListPageState createState() => _BookmarksListPageState();
}
                          ...
                          () {
                            ...
                            if (_selectedIndex == 0) {
                              ...
                              _stream = FirebaseFirestore.instance
                                  .collection('users')
                                  .doc(_id)
                                  .collection('saved-talents')
                                  .snapshots();
                            } else if (_selectedIndex == 2) {
                              _stream = FirebaseFirestore.instance
                                  .collection('users')
                                  .doc(_id)
                                  .collection('saved-sports')
                                  .snapshots();
                            } else if (_selectedIndex == 3) {
                              _stream = FirebaseFirestore.instance
                                  .collection('users')
                                  .doc(_id)
                                  .collection('saved-challenges')
                                  .snapshots();
                            } else {
                              return;
                            }
