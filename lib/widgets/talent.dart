                        ...
                        child: ShaderMask(
                          blendMode: _talent.movieFilter == 'normal'
                              ...
                              : _talent.movieFilter == 'black&white'
                                  ? BlendMode.hue
                                  : _talent.movieFilter == 'yellow&brown' ||
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              ...
                              child: Icon(
                                _isGoldenStar ? Icons.star : Icons.star_border,
                        ...
                        onPressed: () {
                          setState(() {
                            if (!_isClapped) {
                              ...
                              PersonalityService.setTextInput('I really like');
                              PersonalityService.setVideoInput(
                                _talent.videoUrl,
                              );
                            } else {
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Image.asset(
                                'assets/clap.png',
                                color:
                                    !_isClapped ? Colors.white : Colors.black,
                                height: 28,
                                width: 28,
                              ),
                            ),
