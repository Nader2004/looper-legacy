...
class ComedyNativeAd extends StatefulWidget {
  ComedyNativeAd({Key key}) : super(key: key);

  @override
  _ComedyNativeAdState createState() => _ComedyNativeAdState();
}

class _ComedyNativeAdState extends State<ComedyNativeAd> {
